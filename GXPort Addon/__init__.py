...
if "bpy" in locals():
    import importlib
    if "G10_export" in locals():
        importlib.reload(G10_export)
...
class GXPort(Operator, ExportHelper):
    ...
    # Properties for material export
    ...
    def draw(self, context):
        ...
        if self.context_tab == 'Bake':
            # Draw the shader box, material box, and bake settings box
    ...
    def execute(self, context):
        ...
        # Set each working directory to the right place
